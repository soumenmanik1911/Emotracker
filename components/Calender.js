    ...
    return (
        <div className='flex flex-col gap-2'>
            <div className='grid grid-cols-5 gap-4'>
                ...
                }} className='mx-auto pt-8  text-indigo-400 text-lg sm:text-xl duration-200 hover:opacity-60'><img src="/left.png" alt="" srcSet="" /></button>
                <p className={'text-center pt-10 col-span-3 capitalized whitespace-nowrap textGradient text-xl ' + fugaz.className}>{selectedMonth}, {selectedYear}</p>
                <button onClick={() => {
                    handleIncrementMonth(+1)
                }} className='mx-auto pt-8 text-indigo-400 text-xl sm:text-xl duration-200 hover:opacity-60'><img src="/right.png" alt="" srcSet="" /></button>
            </div>
